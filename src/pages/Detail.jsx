      ...
      >
        <div>
          ...
          <div className="text-white">
            <img src={planet?.image} alt="planet" className="mx-auto py-32 w-64" />
            <div className="hidden lg:block">
              ...
              <div className="absolute top-1/3 -translate-y-[80%]  right-0 -translate-x-[50%] 2xl:-translate-x-[180%] space-y-3">
              ...
              <div className="absolute bottom-1/3 translate-y-[120%] 2xl:translate-y-[65%]  right-0 -translate-x-[20%] 2xl:-translate-x-[60%] space-y-3">
                ...
                <h3 className="text-2xl max-w-[21rem] ml-16">
                  {planet?.info3}
                </h3>
              </div>
            </div>
            ...
            <div className="block lg:hidden px-16  ">
              <div className="space-y-6 relative before:absolute before:-left-8 before:w-1 before:h-full before:rounded-md before:bg-white">
                <h3 className="text-lg md:text-2xl relative before:absolute before:w-4 before:h-4 before:bg-white before:top-0 before:-left-[38px] before:rounded-full">
                  {planet?.info1}
                </h3>
